...
Prism.languages.coffee = {
  'built_in': /\b(case|default|function|var|void|with|const|let|enum|export|import|native|__hasProp|__extends|__slice|__bind|__indexOf|implements|interface|let|package|private|protected|public|static|yield)\b/g,
  'string': /("|')(\\?.)*?\1/g,
  'number': /\b-?(0x)?\d*\.?\d+\b/g,
